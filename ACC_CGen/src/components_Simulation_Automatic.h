...
struct components_Simulation_Automatic_RAM_SUBSTRUCT {
   ...
   struct components_DetectCurrentVelocity_Automatic_RAM_SUBSTRUCT DetectCurrentVelocity_instance;
...
struct components_Simulation_Automatic {
   ...
   struct components_DetectCurrentVelocity_Automatic DetectCurrentVelocity_instance;
