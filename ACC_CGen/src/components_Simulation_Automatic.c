...
void components_Simulation_Automatic_calc (void)
{
   ...
   float32 interfaces_interfaces_brake__components_Simulation_Automatic_calc;
   float32 interfaces_interfaces_power__components_Simulation_Automatic_calc;
   float32 interfaces_interfaces_v__components_Simulation_Automatic_calc;
   /* receive messages implicitly */
   {
      DisableAllInterrupts();
      interfaces_interfaces_brake__components_Simulation_Automatic_calc = interfaces_interfaces_brake;
      interfaces_interfaces_power__components_Simulation_Automatic_calc = interfaces_interfaces_power;
      interfaces_interfaces_v__components_Simulation_Automatic_calc = interfaces_interfaces_v;
      EnableAllInterrupts();
   }
   components_Stecke_Automatic_vCar(Stecke_instance_REF, interfaces_interfaces_brake__components_Simulation_Automatic_calc, interfaces_interfaces_power__components_Simulation_Automatic_calc, dT_VAL);
