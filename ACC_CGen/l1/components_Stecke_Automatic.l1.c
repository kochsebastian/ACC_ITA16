 ...
 * Global objects 
 **/
struct L1_components_Stecke_Automatic_Obj* L1_components_Stecke_AutomaticInstance = NULL;
 ...
 **/
struct L1_components_Stecke_Automatic_Obj* initInstance_L1_components_Stecke_Automatic(void)
{
    ...
    L1_components_Stecke_AutomaticInstance = L1_Instance;
