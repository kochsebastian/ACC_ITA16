...
/**
 * @file        ESDL_Linear_Interpolation.h
 *
 * @brief       Function signatures for exemplar linear interpolation
 *
 * @date        2006-2014
 *
...
#warning THESE INTERPOLATION ROUTINES ARE FOR EXAMPLE ONLY! DO NOT USE THIS HEADER FILE IN PRODUCTION CODE! DO NOT USE THIS CODE IN ECUS RUNNING IN ANY VEHICLE!

/**
 * Include ESDL's standard C99-style type definitions
 **/
